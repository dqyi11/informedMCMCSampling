...
for i = 0:1:datasetSize-1
  hmc_filename{i+1} = sprintf('data/45s/simple_HMC_%d.csv', i);
  hnr_filename{i+1} = sprintf('data/45s/simple_HNR_%d.csv', i);
  rs_filename{i+1} = sprintf('data/45s/simple_RS_%d.csv', i);
  hrs_filename{i+1} = sprintf('data/45s/simple_HRS_%d.csv', i);
